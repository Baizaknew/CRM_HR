...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='vacancycomment',
            options={'verbose_name': 'Комментарий к Вакансии', 'verbose_name_plural': 'Комментарии к Вакансии'},
        ),
        migrations.CreateModel(
            name='VacancyHistoryChange',
            fields=[
                ...
                ('vacancy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='changes', to='vacancy.vacancy')),
            ],
            options={
